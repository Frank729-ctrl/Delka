...
app.include_router(checkpoint_router,          tags=["Session Checkpoints"])
app.include_router(audit_router,               tags=["Tool Audit"])
app.include_router(share_router,               tags=["Session Sharing"])
